...
\begin{enumerate}
    ...
    ($\varphi=0, x=0$) oraz ocena czasu regulacji i przeregulowań dla małych wychyleń
    od punktu równowagi.
...
\begin{enumerate}
    ...
    \item \textbf{MPC-J2} -- MPC z funkcją kosztu $J_2$ (uwzględniającą kwadrat sygnału sterującego wprost).
    \item \textbf{Fuzzy-LQR} -- Regulator rozmyty Takagi-Sugeno wspomagany lokalnym LQR.
\end{enumerate}
