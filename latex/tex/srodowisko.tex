...
Symulator opiera się na numerycznym całkowaniu wyprowadzonych wcześniej nieliniowych równań dynamiki. Zaimplementowano procedurę całkowania metodą \textbf{Rungego-Kutty czwartego rzędu (RK4)}, co zapewnia wysoki kompromis pomiędzy dokładnością a szybkością obliczeń.
...
\end{enumerate}
W eksperymentach z zakłóceniami, siła $F_w$ jest dodawana bezpośrednio do równań dynamiki w każdym kroku całkowania. Przykładowy przebieg wygenerowanego sygnału zakłócającego przedstawiono na Rys. \ref{fig:wind_signal}.
