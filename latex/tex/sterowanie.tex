...
W~literaturze przedmiotu \cite{art2, art3} często podkreśla się, że dla
...
$Q_{\theta} \approx 69.44$) znacznie przewyższyły jakością sterowania nastawy
dobrane heurystycznie.
...
Opierając się na~literaturze \cite{art3}, dobrano ręcznie szerokości trójkątnych
