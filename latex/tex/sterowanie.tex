...
wskazały, że początkowe wzmocnienia ($K_{p,\theta}=-60$ dla kąta) zapewniały pewną stabilność,
ale nie były wystarczające do dynamicznego tłumienia zakłóceń.
...
\begin{figure}[H]
    ...
    \caption{Zestawienie przebiegów strojenia regulatora PID.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/tuning/combined/combined_pdlqr.png}
...
Aby zweryfikować dobrane nastawy znów zastosowano algorytm do automatyzacja procesu strojenia, 
...
\begin{figure}[H]
    ...
    1. Słabe wagi (czerwony): $Q=I$.
    2. Optymalne (zielony): $Q_{theta}=15$.}
