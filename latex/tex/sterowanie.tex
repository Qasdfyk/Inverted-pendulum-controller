...
co skutkuje szybszym osiągnięciem zadanego punktu. Jednak czysty LQR nie zapewnia 
zerowego uchybu ustalonego przy stałych zakłóceniach, co motywuje rozszerzenie 
struktury o~dodatkową pętlę PD z~możliwością włączenia członu całkującego.
...
Istotną różnicą między regulatorem PD (bez LQR) a~układem hybrydowym PID-LQR 
...
regulatora PD prowadziło do~oscylacji i~potencjalnej niestabilności 
...
($K_i = -1{,}0$). W~przeciwieństwie do~regulatora PD, gdzie identyczna 
...
gdzie autorzy wykazali, że połączenie regulatora PD z~optymalnym sprzężeniem 
...
że struktura hybrydowa umożliwia bezpieczne rozszerzenie regulatora PD 
o~człon całkujący (tworząc PID), co nie jest możliwe w~konfiguracji bez LQR.
...
drgania przełączeniowe, jednak wzmocnienia reguł były zbyt słabe ($F_{\theta}=20$ vs. optymalne $167.9$).
