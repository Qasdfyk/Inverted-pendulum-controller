...
istotna zmiana w porównaniu do warunków nominalnych. Agresywne strojenie PID-LQR, nastawione na
utrzymanie pozycji wózka, skutkuje mieszanymi rezultatami. Z jednej strony regulator ten 
skutecznie ograniczył dryf pozycji ($Max |x| \approx 0.30$ m vs $0.56$ m dla PID-PID).
Z drugiej jednak, odbyło się to kosztem pogorszenia jakości stabilizacji kąta 
($Max |\theta| \approx 0.096$~rad vs $0.090$~rad) oraz drastycznym wzrostem zużycia energii 
($E_u \approx 33.37$ vs $22.78$). Widać wyraźnie, że w warunkach silnych zakłóceń, 
sztywna walka o utrzymanie pozycji wózka przez PID-LQR jest nieefektywna energetycznie 
i prowadzi do większych chybotliwości wahadła.
