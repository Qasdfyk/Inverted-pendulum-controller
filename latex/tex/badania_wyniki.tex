...
pozycji ($T_{s,x} \approx 1.2$~s). Pod każdym względem PID-LQR oferuje
...
Najlepsze wyniki w warunkach nominalnych osiąga regulator MPC-alt. Dzięki funkcji kosztu
...
zbliżony do regulatora LMPC, choć wciąż wyższy od najbardziej oszczędnych MPC i PID-LQR.
Wyróżnia się jednak bardzo krótkim czasem regulacji ($T_s \approx 0.6$~s), ustępując jedynie PID-LQR i MPC-alt.
...
Regulator Fuzzy-LQR w tym scenariuszu prezentuje się znakomicie.
Osiąga najkrótszy czas regulacji ($T_s \approx 0.6$~s) oraz bardzo niski uchyb całkowy ($IAE_\theta \approx 0.016$),
...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|}
        ...
        $T_{s, \theta}$ & \cellcolor{red!25}1,60000 & \cellcolor{green!25}0,30000 & 1,20000 & 0,40000 & 0,60000 & 1,30000 \\ \hline
        \hline
        $MSE_x$ & 0,00051 & \cellcolor{green!25}0,00038 & \cellcolor{green!25}0,00038 & \cellcolor{red!25}0,00073 & 0,00043 & 0,00039 \\ \hline
        $T_{s, x}$ & 2,00000 & \cellcolor{green!25}1,20000 & 2,20000 & \cellcolor{red!25}4,30000 & 1,80000 & 2,10000 \\ \hline
        \hline
...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|}
        ...
        $T_{s, \theta}$ & \cellcolor{red!25}2,80000 & 0,90000 & 1,30000 & 1,30000 & \cellcolor{green!25}0,60000 & 1,40000 \\ \hline
        \hline
        $MSE_x$ & \cellcolor{red!25}0,00065 & \cellcolor{green!25}0,00038 & 0,00038 & 0,00038 & 0,00043 & 0,00040 \\ \hline
        $T_{s, x}$& \cellcolor{red!25}3,10000 & \cellcolor{green!25}1,10000 & 2,00000 & 2,00000 & 1,80000 & 1,90000 \\ \hline
        \hline
