...
agresywny LQR zużywa więcej energii ($E_u \approx 1.48$) niż "miękki" regulator PID
($E_u \approx 0.85$), który pozwala sobie na dłuższe i łagodniejsze dochodzenie do równowagi.
Obserwujemy zatem zmianę charakterystyki: PID stał się rozwiązaniem bardziej ekonomicznym w
...
Na drugim biegunie znajduje się regulator MPC. Zastosowanie horyzontu predykcji pozwala
...
rozhustanie się układu, podczas gdy PID walczy ze skutkami oscylacji, które sam dopuścił.
...
Warto odnotować całkowitą porażkę wariantu MPC-J2 w tym teście. Jego funkcja kosztu, penalizująca
...
kąta wychylenia i przewrócenia się wahadła. Jest to cenna lekcja projektowa, pokazująca jak 
dobór funkcji celu determinuje odporność układu.
