...
charakteryzuje się krótkim czasem regulacji ($T_s \approx 2{,}1$~s). Jest to wynik
dwukrotnie lepszy od regulatora PID-PID ($T_s \approx 4{,}2$~s), który wykazuje znacznie
...
pozycji ($T_{s,x} \approx 1{,}6$~s w porównaniu do $4{,}6$~s). Pod każdym względem PID-LQR oferuje
...
Najlepsze wyniki w warunkach nominalnych osiąga regulator PID-LQR oraz MPC.
MPC-alt (J2), mimo funkcji kosztu karającej bezpośrednio sterowanie, uzyskuje czas regulacji ($T_s \approx 2{,}7$~s).
Lepszą dynamikę wykazuje standardowy MPC ($T_s \approx 2{,}1$~s), który dorównuje PID-LQR.
...
Standardowy regulator MPC (nieliniowy) działa równie szybko jak PID-LQR.
Jego czas regulacji wynosi $T_s \approx 2{,}1$~s.
Mimo dobrej reakcji, charakteryzuje się bardzo niskim kosztem energetycznym ($E_u \approx 0{,}56$),
...
warunkach nominalnych najlepszą dynamikę oferują regulatory PID-LQR oraz MPC, 
które najszybciej sprowadzają wahadło do~pionu przy umiarkowanym przemieszczeniu wózka. 
Widać wyraźny kontrast między metodami szybkimi a~zachowawczym regulatorem PID-PID, 
który charakteryzuje się znacznie dłuższym czasem regulacji. Zestawienie to uwidacznia 
...
W grupie zaawansowanej (Rys. \ref{fig:wind_advanced}--\ref{fig:wind_control_advanced})
Fuzzy-LQR potwierdza swoją skuteczność, choć nie dominuje już we wszystkich kategoriach.
...
Pod względem zużycia energii ($E_u \approx 13.97$) ustępuje on jednak nieco regulatorom MPC i PID-LQR.
...
Wykresy te dobitnie pokazują przewagę regulatora Fuzzy-LQR oraz PID-LQR 
w tłumieniu zakłóceń.
Widać wyraźnie, że metody te utrzymują oscylacje wahadła w najwęższym paśmie, 
podczas gdy klasyczny PID-PID oraz predykcyjne MPC pozwalają na znacznie większe wychylenia.
...
przewyższając pod tym względem nawet PID-LQR.
...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|}
        ...
        $MSE_\theta$ & \cellcolor{red!25}0,00011 & 0,00005 & 0,00006 & 0,00007 & \cellcolor{green!25}0,00005 & 0,00008 \\ \hline
        $IAE_\theta$ & \cellcolor{red!25}0,04567 & 0,01805 & 0,02323 & 0,02848 & \cellcolor{green!25}0,01578 & 0,02992 \\ \hline
        $T_{s, \theta}$ & \cellcolor{red!25}4,20000 & \cellcolor{green!25}2,10000 & 2,10000 & 2,70000 & 2,30000 & 3,10000 \\ \hline
        \hline
        $MSE_x$ & 0,00051 & \cellcolor{green!25}0,00038 & \cellcolor{green!25}0,00038 & \cellcolor{red!25}0,00073 & 0,00043 & 0,00039 \\ \hline
        $T_{s, x}$ & 4,60000 & \cellcolor{green!25}1,60000 & 3,60000 & \cellcolor{red!25}5,20000 & 3,00000 & 2,70000 \\ \hline
        \hline
        $E_{u}$ & \cellcolor{red!25}0,95046 & 0,59229 & 0,55762 & \cellcolor{green!25}0,51499 & 0,77627 & 0,78994 \\ \hline
    \end{tabular}
\end{table}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|}
        \hline
        Wskaźnik & PID-PID & PID-LQR & MPC & MPC-alt & Fuzzy-LQR & LMPC \\ \hline
        $MSE_\theta$ & \cellcolor{red!25}\phantom{0}0,00146 & \phantom{0}0,00057 & \phantom{0}0,00058 & \phantom{0}0,00063 & \cellcolor{green!25}\phantom{0}0,00054 & \phantom{0}0,00118 \\ \hline
        $IAE_\theta$ & \cellcolor{red!25}\phantom{0}0,30988 & \phantom{0}0,18541 & \phantom{0}0,18151 & \phantom{0}0,18607 & \cellcolor{green!25}\phantom{0}0,17797 & \phantom{0}0,27259 \\ \hline
        $Max |\theta|$ & \cellcolor{red!25}\phantom{0}0,09006 & \cellcolor{green!25}\phantom{0}0,06187 & \phantom{0}0,06246 & \phantom{0}0,06715 & \phantom{0}0,06344 & \phantom{0}0,08539 \\ \hline
        \hline
        $MSE_x$ & \phantom{0}0,04382 & \cellcolor{green!25}\phantom{0}0,00522 & \phantom{0}0,01843 & \cellcolor{red!25}\phantom{0}0,04383 & \phantom{0}0,00859 & \phantom{0}0,01551 \\ \hline
        $Max |x|$ & \phantom{0}0,55997 & \cellcolor{green!25}\phantom{0}0,26817 & \phantom{0}0,40938 & \cellcolor{red!25}\phantom{0}0,56993 & \phantom{0}0,31153 & \phantom{0}0,39981 \\ \hline
        \hline
        $E_{u}$ & \cellcolor{red!25}22,77583 & 12,56274 & 12,43920 & \cellcolor{green!25}12,26560 & 13,96835 & 22,74390 \\ \hline
    \end{tabular}
\end{table}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|}
        \hline
        Wskaźnik & PID-PID & PID-LQR & MPC & MPC-alt & Fuzzy-LQR & LMPC \\ \hline
        $MSE_\theta$ & \cellcolor{red!25}0,00015 & 0,00005 & 0,00007 & 0,00007 & \cellcolor{green!25}0,00005 & 0,00009 \\ \hline
        $IAE_\theta$ & \cellcolor{red!25}0,06524 & 0,01854 & 0,02517 & 0,02530 & \cellcolor{green!25}0,01620 & 0,03379 \\ \hline
        $T_{s, \theta}$ & \cellcolor{red!25}6,80000 & 2,00000 & 2,00000 & 2,00000 & \cellcolor{green!25}2,30000 & 2,90000 \\ \hline
        \hline
        $MSE_x$ & \cellcolor{red!25}0,00065 & \cellcolor{green!25}0,00038 & 0,00038 & 0,00038 & 0,00043 & 0,00040 \\ \hline
        $T_{s, x}$& \cellcolor{red!25}8,30000 & \cellcolor{green!25}1,60000 & 3,00000 & 3,00000 & 3,10000 & 2,20000 \\ \hline
        \hline
        $E_{u}$ & \cellcolor{red!25}1,49205 & \cellcolor{green!25}0,62520 & 0,64753 & 0,64818 & 0,79775 & 1,01039 \\ \hline
    \end{tabular}
\end{table}
