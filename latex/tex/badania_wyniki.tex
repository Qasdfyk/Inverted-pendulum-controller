...
klasyczne, do których zaliczono równoległy układ PID-PID oraz hybrydowy PID-LQR, oraz regulatory
...
o~33\% lepszy od~regulatora PID-PID ($T_s \approx 0.3$~s). PID-LQR działa z~wysoką dynamiką,
...
LQR o~wysokich wzmocnieniach zużywa więcej energii ($E_u \approx 1.48$) niż regulator PID-PID 
o~łagodniejszej charakterystyce ($E_u \approx 0.85$), który charakteryzuje się dłuższym 
i~łagodniejszym dochodzeniem do~równowagi. Można zatem zaobserwować zmianę charakterystyki: PID-PID stał się 
...
najkrótszy w~porównaniu z~innymi regulatorami i wynosi zaledwie 0.80 s. Ma to jednak swoją cenę w zachowaniu wózka. Aby
...
energetycznym wyższym o~394\% względem MPC ($E_u \approx 2.75$ vs. $0.56$), co może być 
...
kąt ($Max |\theta| \approx 0.060$ vs $0.068$~rad dla PID-PID), ale przede wszystkim istotnie
redukuje dryf pozycji ($Max |x| \approx 0.22$ m vs $0.26$ m). Warto zauważyć, że
osiąga to przy niższym zużyciu energii ($E_u \approx 11.7$) niż regulator PID-PID ($15.4$).
Wynika to z faktu, że optymalny regulator tłumi zakłócenie w~zarodku, nie pozwalając na
rozhustanie się układu, podczas gdy PID-PID kompensuje skutki oscylacji, które sam dopuścił.
...
jest znaczący ($E_u \approx 25.4$). Sterownik ten charakteryzuje się strategią sterowania 
...
dryfem wózka w zestawieniu ($Max |x| \approx 0.41$ m), gdyż układ jest spychany przez siłę zakłócającą, 
ale za to zużycie energii jest niskie ($E_u \approx 12.4$). Warto zauważyć, że w~tych konkretnych 
warunkach PD-LQR okazał się lepszy od MPC zarówno pod względem trzymania pozycji, jak i zużycia energii,
...
Regulatory klasyczne (PID-PID, PID-LQR) okazały się bardziej odporne na~perturbację
...
uchybu, a~nie predykowanych stanów. W~szczególności regulator PID-LQR, dzięki
...
\begin{itemize}
    ...
    \item \textbf{Regulatory klasyczne (PID-PID, PID-LQR)} również charakteryzują się
...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|c|c|c|c|c|}
        \hline
        Wskaźnik & PID-PID & PID-LQR & MPC & MPC-J2 & Fuzzy-LQR \\ \hline
        $MSE_\theta$ & 0.00005 & 0.00004 & 0.00006 & 0.00005 & 0.00009 \\ \hline
        $IAE_\theta$ & 0.01684 & 0.01259 & 0.02323 & 0.01854 & 0.02661 \\ \hline
        $T_{s, \theta}$ [s] & 0.30000 & 0.20000 & 1.20000 & 0.30000 & 0.80000 \\ \hline
        \hline
        $MSE_x$ & 0.00040 & 0.00048 & 0.00038 & 0.00038 & 0.00035 \\ \hline
        $T_{s, x}$ [s] & 1.20000 & 2.20000 & 2.20000 & 1.10000 & 1.00000 \\ \hline
        \hline
        $E_{u}$ & 0.84515 & 1.47775 & 0.55762 & 0.59132 & 2.75440 \\ \hline
    \end{tabular}
\end{table}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|c|c|c|c|c|}
        \hline
        Wskaźnik & PID-PID & PID-LQR & MPC & MPC-J2 & Fuzzy-LQR \\ \hline
        $MSE_\theta$ & 0.00060 & 0.00044 & 0.00058 & 0.00066 & 0.00036 \\ \hline
        $IAE_\theta$ & 0.18981 & 0.16304 & 0.18151 & 0.20064 & 0.14650 \\ \hline
        $Max |\theta|$ [rad] & 0.06821 & 0.06017 & 0.06246 & 0.06468 & 0.05082 \\ \hline
        \hline
        $MSE_x$ & 0.00466 & 0.00328 & 0.01843 & 0.00462 & 0.00363 \\ \hline
        $Max |x|$ [m] & 0.26214 & 0.22189 & 0.40938 & 0.26306 & 0.22965 \\ \hline
        \hline
        $E_{u}$ & 15.39160 & 11.73032 & 12.43920 & 17.31098 & 25.36657 \\ \hline
    \end{tabular}
\end{table}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|c|c|c|c|c|}
        ...
        $IAE_\theta$ & 0.01687 & 0.01262 & 0.02346 & 0.02130 & 0.02870 \\ \hline
        $T_{s, \theta}$ [s] & 0.30000 & 0.20000 & 1.20000 & 1.00000 & 1.10000 \\ \hline
        \hline
        $MSE_x$ & 0.00040 & 0.00048 & 0.00038 & 0.00047 & 0.00037 \\ \hline
        $T_{s, x}$ [s] & 1.20000 & 2.20000 & 2.20000 & 1.00000 & 2.30000 \\ \hline
        \hline
        $E_{u}$ & 0.84540 & 1.46812 & 0.56480 & 0.61222 & 1.46148 \\ \hline
    \end{tabular}
\end{table}
...
ok. 4\% energii całkowitej ($E_u$ spada z 0.59 do 0.57), przy praktycznie niezauważalnym pogorszeniu
...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|c|c|}
        ...
        $MSE_\theta$ & 0.00005 & 0.00005 \\ \hline
        $T_{s, \theta}$ [s] & 0.30000 & 1.00000 \\ \hline
        $E_{u}$ & 0.59132 & 0.56723 \\ \hline
    \end{tabular}
\end{table}
