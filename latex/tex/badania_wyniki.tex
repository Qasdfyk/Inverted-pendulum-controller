...
klasyczne, do których zaliczono równoległy układ PD oraz hybrydowy PD-LQR, oraz regulatory
...
o~33\% lepszy od~regulatora PD ($T_s \approx 0.3$~s). PD-LQR działa z~wysoką dynamiką,
...
rozwiązaniem bardziej ekonomicznym w~stanie przejściowym, podczas gdy PD-LQR charakteryzuje się 
...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|c|c|c|c|c|}
        \hline
        Wskaźnik & PD & PD-LQR & MPC & MPC-J2 & Fuzzy-LQR \\ \hline
...
Regulatory klasyczne (PD, PD-LQR) oraz rozmyty (Fuzzy-LQR) charakteryzują się
