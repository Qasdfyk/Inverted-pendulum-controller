...
(Rys. \ref{fig:nom_classical}), można zaobserwować, że oba regulary radzą sobie ze stabilizacją,
...
Mamy więc do czynienia z zamianą ról: PD-PD stał się rozwiązaniem bardziej ekonomicznym w
stanie przejściowym, podczas gdy PD-LQR przejął rolę wyczynowego sprintera.
...
co czyni MPC bezapelacyjnym liderem ekonomii w warunkach nominalnych.
...
karę za zmianę pozycji, przyniosło spektakularne efekty. LQR nie tylko lepiej stabilizuje
kąt ($Max |\theta| \approx 0.060$ vs $0.068$ rad dla PD-PD), ale przede wszystkim drastycznie
redukuje dryf pozycji ($Max |x| \approx 0.22$ m vs $0.26$ m). Co najbardziej zaskakujące,
robi to zużywając MNIEJ energii ($E_u \approx 11.7$) niż regulator PD-PD ($15.4$).
...
regulator Fuzzy-LQR pozostaje bezkonkurencyjny w dziedzinie precyzji kątowej
($Max |\theta| \approx 0.05$ rad -- praktycznie brak wychylenia), jednak cena energetyczna
pozostaje zaporowa ($E_u \approx 85.9$). Jest to sterownik typu "nieustępliwy" -- używa
każdej dostępnej mocy, by zniwelować błąd.
...
minimalnym narzucie implementacyjnym. W naszych testach PD-LQR, po odpowiednim doborze wag
($Q_x = 500$), okazał się rozwiązaniem niezwykle uniwersalnym -- w warunkach wietrznych
pokonał konkurencję klasyczną i nawiązał równorzędną walkę z MPC pod względem energetycznym,
oferując znacznie lepsze trzymanie pozycji.
