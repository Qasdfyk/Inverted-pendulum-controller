...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[auto, node distance=1.4cm, >=Stealth]
        ...
        % Macierze B
        \node [block, right=0.8cm of u_in, minimum width=2em] (B) {$B$};
        \node [block, right=0.8cm of fw_in, minimum width=2em] (Bd) {$B_d$};
        ...
        \node [block, below=1.2cm of sum1, xshift=0.6cm, minimum width=2em] (A) {$A$};
        
        % --- Połączenia ---
        % Wejścia -> Macierze B
        \draw [arrow] (u_in) -- node[above, font=\scriptsize] {$u$} (B);
        \draw [arrow] (fw_in) -- node[above, font=\scriptsize] {$F_w$} (Bd);
        ...
        \draw [arrow] (sum1) -- node[above, font=\scriptsize] {$\dot{x}$} (int);
