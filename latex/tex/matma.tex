...
\begin{figure}[H]
    ...
    \caption{Źródło: \cite{Prasad2014}. Schemat układu odwróconego wahadła na wózku.}
...
% Definicja pomocnicza (można dać w tekście przed równaniem lub jako osobne równanie)
\begin{equation}
...
Definiując wektor stanu \(x(t) = [\theta(t), \dot{\theta}(t), x(t), \dot{x}(t)]^T\), 
