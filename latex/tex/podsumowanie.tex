...
Kod źródłowy projektu dostępny na \href{https://github.com/Qasdfyk/Inverted-pendulum-controller}{github}.
...
fizyczne napędu. Jako rozwiązanie alternatywne można wskazać regulator hybrydowy PID-LQR, 
który w warunkach nominalnych zapewnia szybką stabilizację pozycji. Jednak w obecności 
silnych zakłóceń, jego agresywne działanie prowadzi do zwiększonego zużycia energii 
oraz większych oscylacji wahadła w porównaniu do metod predykcyjnych. Badania potwierdziły również, że kluczowym
