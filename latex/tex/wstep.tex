...
(PD, PID-LQR, MPC, Fuzzy-LQR). Kluczowa jest również możliwość weryfikacji 
...
\begin{enumerate}
    ...
    PID (w~pętli regulacji pozycji, z~członem całkującym) z~optymalnym regulatorem stanu LQR 
