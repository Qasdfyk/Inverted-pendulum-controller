...
fizycznych napędu, co jest kluczowe w systemach rzeczywistych. Układ PID-LQR stanowił kompromis między 
...
nonlinear inverted pendulum system on a cart. As part of the research, six 
control strategies were implemented and tested: a classical parallel PID 
controller, a hybrid PID-LQR system, Model Predictive Control 
(Linear MPC, Nonlinear MPC and MPC-J2 with an extended cost function), and a Takagi-Sugeno fuzzy 
...
The PID-LQR system represented a compromise between computational complexity and control 
