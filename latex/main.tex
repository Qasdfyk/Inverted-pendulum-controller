...
klasyczny regulator równoległy PID, układ hybrydowy PID-LQR, nieliniowe sterowanie predykcyjne (MPC) 
...
controller, a hybrid PID-LQR system, nonlinear Model Predictive Control (MPC) 
